...
import static coffeeshopmanagementsystemparttwo.CoffeeShopManagementSystem.products;
import static coffeeshopmanagementsystemparttwo.CoffeeShopManagementSystem.addProduct;
import static coffeeshopmanagementsystemparttwo.CoffeeShopManagementSystem.editProduct;
...
public class ProductPage extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        if (!jTextField1.getText().trim().isEmpty()
            ...
            if (!found) {
                addProduct(product_id, product_name, product_price, product_category, product_stock);
                JOptionPane.showMessageDialog(null, "New Product Record Successfully Added!");
            } else {
                editProduct(product_id, product_name, product_price, product_category, product_stock);
                JOptionPane.showMessageDialog(null, "Product ID already exists! Use a different ID.");
            }
        } else {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        if (selectedRow != -1) {
            ...
            jTextField1.setText(String.valueOf(product.getProduct_id()));
    ...
    public void refresh_JTable() {
        ...
        for (Product product : products) {
            Object[] rowData = { product.getProduct_id(), product.getName(), product.getPrice(),
